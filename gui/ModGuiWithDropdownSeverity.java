...
public class ModGuiWithDropdownSeverity extends GuiScreen
{
	/** The parent GUI **/
	...
	private int selectedBunishment;
	
	/** Tells which severity is selected **/
	private int selectedSeverity = 1;
	
    public ModGuiWithDropdownSeverity(GuiScreen parentScreenParam, int selectedBunishmentParam, String nameFieldTextParam, int selectedseverityParam)
    {
	...
	public void initGui()
	{
    	...
    	{
    		case 1:
    			this.buttonList.add(new GuiButton(201, this.width / 2 + xSpacing + (smallButtonWidth - 20), spaceFromTop + 20, 20, 20, "1"));
    			this.buttonList.add(new GuiButton(202, this.width / 2 + xSpacing + (smallButtonWidth - 20), spaceFromTop + 40, 20, 20, "2"));
    			this.buttonList.add(new GuiButton(203, this.width / 2 + xSpacing + (smallButtonWidth - 20), spaceFromTop + 60, 20, 20, "3"));
    			break;
    		case 2:
    			this.buttonList.add(new GuiButton(202, this.width / 2 + xSpacing + (smallButtonWidth - 20), spaceFromTop + 20, 20, 20, "2"));
    			this.buttonList.add(new GuiButton(201, this.width / 2 + xSpacing + (smallButtonWidth - 20), spaceFromTop + 40, 20, 20, "1"));
    			this.buttonList.add(new GuiButton(203, this.width / 2 + xSpacing + (smallButtonWidth - 20), spaceFromTop + 60, 20, 20, "3"));
    			break;
    		case 3:
    			this.buttonList.add(new GuiButton(203, this.width / 2 + xSpacing + (smallButtonWidth - 20), spaceFromTop + 20, 20, 20, "3"));
    			this.buttonList.add(new GuiButton(201, this.width / 2 + xSpacing + (smallButtonWidth - 20), spaceFromTop + 40, 20, 20, "1"));
    			this.buttonList.add(new GuiButton(202, this.width / 2 + xSpacing + (smallButtonWidth - 20), spaceFromTop + 60, 20, 20, "2"));
    			break;
    	}
	...
	protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 22:
            	...
            	break;
            case 100:
            	this.mc.displayGuiScreen(new ModGuiWithDropdownBun(this.parentScreen, 0, this.nameField.getText(), this.selectedSeverity));
            	break;
            case 101:
            	this.mc.displayGuiScreen(new ModGuiWithDropdownBun(this.parentScreen, 1, this.nameField.getText(), this.selectedSeverity));
            	break;
            case 102:
            	this.mc.displayGuiScreen(new ModGuiWithDropdownBun(this.parentScreen, 2, this.nameField.getText(), this.selectedSeverity));
            	break;
            case 103:
            	this.mc.displayGuiScreen(new ModGuiWithDropdownBun(this.parentScreen, 3, this.nameField.getText(), this.selectedSeverity));
            	break;
            case 104:
            	this.mc.displayGuiScreen(new ModGuiWithDropdownBun(this.parentScreen, 4, this.nameField.getText(), this.selectedSeverity));
            	break;
            case 105:
            	this.mc.displayGuiScreen(new ModGuiWithDropdownBun(this.parentScreen, 5, this.nameField.getText(), this.selectedSeverity));
            	break;
            case 201:
            	this.mc.displayGuiScreen(new ModGui(this.selectedBunishment, this.nameField.getText(), 1));
            	break;
            case 202:
            	this.mc.displayGuiScreen(new ModGui(this.selectedBunishment, this.nameField.getText(), 2));
            	break;
            case 203:
            	this.mc.displayGuiScreen(new ModGui(this.selectedBunishment, this.nameField.getText(), 3));
            	break;
            case 47:
            	this.sendBun();
            	exitGui();
