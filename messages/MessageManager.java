...
public class MessageManager
{
	public MessageManager(OptionManager options)
	{
		...
		registerMessage(new LoadableMessage(MessageType.CUSTOM1, options, OptionKey.customOne1, OptionKey.customOne2));
		registerMessage(new LoadableMessage(MessageType.CUSTOM2, options, OptionKey.customTwo1, OptionKey.customTwo2));
		registerMessage(new LoadableMessage(MessageType.CUSTOM3, options, OptionKey.customThree1, OptionKey.customThree2));
	}
